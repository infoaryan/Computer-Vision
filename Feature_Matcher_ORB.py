...
#Read the query image as query_img and traing image
...
query_img =cv2.resize(query_img,(400,600))
train_img = cv2.imread('train.jpg')
train_img =cv2.resize(train_img, (400,600))
